...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__27963 = c;
var G__27963__$1 = (((G__27963 == null))?null:G__27963.prototype);
if((G__27963__$1 == null)){
return null;
} else {
return G__27963__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__27964 = c;
var G__27964__$1 = (((G__27964 == null))?null:G__27964.prototype);
if((G__27964__$1 == null)){
return null;
} else {
return G__27964__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__27986__delegate = function (args){
...
while (G__27987__i < G__27987__a.length) {G__27987__a[G__27987__i] = arguments[G__27987__i + 0]; ++G__27987__i;}
  args = new cljs.core.IndexedSeq(G__27987__a,0,null);
} 
...
var args = cljs.core.seq(arglist__27988);
...
var or__5002__auto__ = (function (){var G__27966 = c;
var G__27966__$1 = (((G__27966 == null))?null:G__27966.constructor);
if((G__27966__$1 == null)){
return null;
} else {
return G__27966__$1.displayName;
}
})();
...
var G__27967 = c;
var G__27967__$1 = (((G__27967 == null))?null:G__27967.constructor);
if((G__27967__$1 == null)){
return null;
} else {
return G__27967__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__27968 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__27969 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__27969);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__27968);
}});
...
var c = this;
var G__27972_27994 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__27972_27994 == null)){
} else {
reagent.ratom.dispose_BANG_(G__27972_27994);
}
...
var renders_27995 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_27996 = cljs.core.first(cljs.core.vals(renders_27995));
...
if((cljs.core.count(renders_27995) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_27995))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_27996)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_27996], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__27973 = o;
reagent.impl.component.goog$module$goog$object.set(G__27973,cljs.core.name(k),v);
...
return (function() { 
var G__27998__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__27999__i < G__27999__a.length) {G__27999__a[G__27999__i] = arguments[G__27999__i + 0]; ++G__27999__i;}
  args = new cljs.core.IndexedSeq(G__27999__a,0,null);
} 
...
var args = cljs.core.seq(arglist__28000);
...
var vec__27976 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27976,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27976,(1),null);
...
var G__27979 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__27979 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__27979);
}
});
}),[]);
