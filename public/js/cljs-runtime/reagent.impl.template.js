...
var G__28003 = o;
reagent.impl.template.goog$module$goog$object.set(G__28003,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
var G__28004 = o;
reagent.impl.template.goog$module$goog$object.set(G__28004,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__28026__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__28027__i < G__28027__a.length) {G__28027__a[G__28027__i] = arguments[G__28027__i + 0]; ++G__28027__i;}
  args = new cljs.core.IndexedSeq(G__28027__a,0,null);
} 
...
var args = cljs.core.seq(arglist__28028);
...
var G__28005 = props;
var G__28005__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28005,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__28005);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28005__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__28006 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28006,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__28006;
}
})(),id_class);
...
var G__28007 = (cljs.core.count(argv) - first_child);
switch (G__28007) {
case (0):
...
var vec__28008 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28008,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28008,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28008,(2),null);
...
var temp__5827__auto___28052 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___28052 == null)){
} else {
var key_28053 = temp__5827__auto___28052;
(jsprops.key = key_28053);
}
...
var temp__5827__auto___28055 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___28055 == null)){
} else {
var key_28056 = temp__5827__auto___28055;
(jsprops.key = key_28056);
}
...
var temp__5827__auto___28058 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___28058 == null)){
} else {
var key_28060 = temp__5827__auto___28058;
(jsprops.key = key_28060);
}
...
var temp__5827__auto___28069 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___28069 == null)){
} else {
var key_28070 = temp__5827__auto___28069;
(jsprops.key = key_28070);
}
...
var temp__5827__auto___28071 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___28071 == null)){
} else {
var key_28072 = temp__5827__auto___28071;
(jsprops.key = key_28072);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28011_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__28011_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__28012 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28012,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28012,(1),null);
...
break;
default:
var G__28078 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__28079 = compiler;
v = G__28078;
compiler = G__28079;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template28018 = (function (opts,id,fn_to_element,parse_fn,meta28019){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template28018.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_28020,meta28019__$1){
var self__ = this;
var _28020__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template28018(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta28019__$1));
}));

(reagent.impl.template.t_reagent$impl$template28018.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_28020){
var self__ = this;
var _28020__$1 = this;
return self__.meta28019;
}));

(reagent.impl.template.t_reagent$impl$template28018.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template28018.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template28018.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template28018.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template28018.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template28018.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta28019","meta28019",2108227040,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template28018.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template28018.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template28018");

(reagent.impl.template.t_reagent$impl$template28018.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template28018");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template28018.
 */
reagent.impl.template.__GT_t_reagent$impl$template28018 = (function reagent$impl$template$__GT_t_reagent$impl$template28018(opts,id,fn_to_element,parse_fn,meta28019){
return (new reagent.impl.template.t_reagent$impl$template28018(opts,id,fn_to_element,parse_fn,meta28019));
});
...
return (new reagent.impl.template.t_reagent$impl$template28018(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
