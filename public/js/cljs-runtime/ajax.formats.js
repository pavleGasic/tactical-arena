...
var G__28212 = request;
var G__28213 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__28212,G__28213) : ajax.formats.get_format.call(null, G__28212,G__28213));
} else {
...
return ajax.formats.content_type_matches(content_type,p1__28215_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__28219){
var map__28220 = p__28219;
var map__28220__$1 = cljs.core.__destructure_map(map__28220);
var request = map__28220__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28220__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__28226 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__28226.cljs$core$IFn$_invoke$arity$1 ? fexpr__28226.cljs$core$IFn$_invoke$arity$1(response) : fexpr__28226.call(null, response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__28229){
var map__28230 = p__28229;
var map__28230__$1 = cljs.core.__destructure_map(map__28230);
var request = map__28230__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28230__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__28228_SHARP_){
return ajax.formats.get_accept_entries(request,p1__28228_SHARP_);
