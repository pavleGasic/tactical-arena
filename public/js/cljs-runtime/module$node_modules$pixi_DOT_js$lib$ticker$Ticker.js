shadow$provide.module$node_modules$pixi_DOT_js$lib$ticker$Ticker = function(global, require, module, exports) {
  ...
  "use strict";
  const node_modules$pixi_DOT_js$lib$ticker$Ticker$classdecl$var4 = class {
    constructor() {
      this.autoStart = !1;
      this.deltaTime = 1;
      this.lastTime = -1;
      ...
      this.deltaMS = 1 / node_modules$pixi_DOT_js$lib$ticker$Ticker$classdecl$var4.targetFPMS;
      this.elapsedMS = 1 / node_modules$pixi_DOT_js$lib$ticker$Ticker$classdecl$var4.targetFPMS;
      this._tick = time => {
        this._requestId = null;
    ...
    update(currentTime = performance.now()) {
      if (currentTime > this.lastTime) {
        ...
        this.deltaTime = this.deltaMS * node_modules$pixi_DOT_js$lib$ticker$Ticker$classdecl$var4.targetFPMS;
    ...
    set minFPS(fps) {
      this._maxElapsedMS = 1 / Math.min(Math.max(0, Math.min(this.maxFPS, fps)) / 1e3, node_modules$pixi_DOT_js$lib$ticker$Ticker$classdecl$var4.targetFPMS);
    }
    get maxFPS() {
    ...
    static get shared() {
      if (!node_modules$pixi_DOT_js$lib$ticker$Ticker$classdecl$var4._shared) {
        const shared = node_modules$pixi_DOT_js$lib$ticker$Ticker$classdecl$var4._shared = new node_modules$pixi_DOT_js$lib$ticker$Ticker$classdecl$var4();
        shared.autoStart = !0;
        shared._protected = !0;
      }
      return node_modules$pixi_DOT_js$lib$ticker$Ticker$classdecl$var4._shared;
    }
    static get system() {
      if (!node_modules$pixi_DOT_js$lib$ticker$Ticker$classdecl$var4._system) {
        const system = node_modules$pixi_DOT_js$lib$ticker$Ticker$classdecl$var4._system = new node_modules$pixi_DOT_js$lib$ticker$Ticker$classdecl$var4();
        system.autoStart = !0;
        system._protected = !0;
      }
      return node_modules$pixi_DOT_js$lib$ticker$Ticker$classdecl$var4._system;
    }
  };
  global = node_modules$pixi_DOT_js$lib$ticker$Ticker$classdecl$var4;
