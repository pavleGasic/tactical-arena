shadow$provide.module$node_modules$$pixi$core$lib$shader$utils$logProgramError = function(global, require, module, exports) {
  function logPrettyShaderError(gl, shader) {
    const shaderSrc = gl.getShaderSource(shader).split("\n").map((line, index) => `${index}: ${line}`);
    gl = gl.getShaderInfoLog(shader);
    const dedupe = {}, logArgs = [""];
    gl.split("\n").map(line => parseFloat(line.replace(/^ERROR: 0:([\d]+):.*$/, "$1"))).filter(n => n && !dedupe[n] ? (dedupe[n] = !0, !0) : !1).forEach(number => {
...
//# sourceMappingURL=module$node_modules$$pixi$core$lib$shader$utils$logProgramError.js.map
