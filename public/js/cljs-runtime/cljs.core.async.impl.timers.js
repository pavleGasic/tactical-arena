...
var i_30417 = (self__.level + (1));
while(true){
if((i_30417 <= (new_level + (1)))){
(update[i_30417] = self__.header);

var G__30419 = (i_30417 + (1));
i_30417 = G__30419;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_30425 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_30425[i]));
} else {
x__$2.forward.push((((i < links_30425.length))?(links_30425[i]):null));
}

if((i < links_30425.length)){
(links_30425[i] = x__$2);
} else {
links_30425.push(x__$2);
}
...
var i_30431 = (0);
while(true){
if((i_30431 <= self__.level)){
var links_30432 = (update[i_30431]).forward;
if((x__$1 === (((i_30431 < links_30432.length))?(links_30432[i_30431]):null))){
(links_30432[i_30431] = (x__$1.forward[i_30431]));

var G__30434 = (i_30431 + (1));
i_30431 = G__30434;
continue;
} else {
var G__30435 = (i_30431 + (1));
i_30431 = G__30435;
continue;
}
} else {
...
var G__30446 = nx;
var G__30447 = (level__$1 - (1));
x = G__30446;
level__$1 = G__30447;
continue;
} else {
var G__30452 = x;
var G__30453 = (level__$1 - (1));
x = G__30452;
level__$1 = G__30453;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__30469 = nx;
var G__30470 = (level__$1 - (1));
x = G__30469;
level__$1 = G__30470;
continue;
} else {
var G__30471 = x;
var G__30472 = (level__$1 - (1));
x = G__30471;
level__$1 = G__30472;
continue;
}
